...
const ForgotPasswordScreen = ({ navigation }) => {
    ...
    const handleForgotPassword = async () => {
        ...
        try {
            ...
            console.log(t('forgotPassword.successMessage'), response);
            setModalTitle(t('common.success'));
            setModalMessage(t('forgotPassword.successMessage'));
            setModalVisible(true);
        } catch (err) {
            const errorCode = err.message;
            console.error(t("forgotPassword.errorMessage"), errorCode);
    ...
    const handleModalClose = () => {
        ...
        if (modalTitle === t("common.success")) {
            navigation.navigate('EnterOtpForPasswordReset', { email });
        }
    };
