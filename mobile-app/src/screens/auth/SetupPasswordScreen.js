...
import { setupPassword } from "../../api/auth/authApi";
...
const SetupPasswordScreen = ({ navigation }) => {
    ...
    const handleSetupPassword = async () => {
        ...
        if (password !== confirmPassword) {
            ...
            setModalMessage(t("setupPassword.passwordMismatch"));
        ...
        try {
            await setupPassword(token, password, firstName, lastName);
            setModalTitle(t("common.success"));
            setModalMessage(t("setupPassword.successMessage"));
            setModalVisible(true);
        } catch (err) {
            const errorCode = err.message;
            console.error("Setup password failed:", errorCode);
            ...
            >
                ...
                >
                    ...
                    <View style={styles.titleContainer}>
                        <Text style={styles.title}>{t("setupPassword.title")}</Text>
                    ...
                    <View style={styles.passwordContainer}>
                        <FontAwesome name="user" size={20} color="#aaaaaa" style={{ paddingLeft: 15, paddingRight: 5, alignSelf: 'center' }} />
                        <TextInput
                    ...
                    <View style={styles.passwordContainer}>
                        ...
                        <TextInput
                            style={styles.passwordInput}
                            placeholder={t("setupPassword.newPasswordPlaceholder")}
                            placeholderTextColor="#aaaaaa"
                            value={password}
                    ...
                    <View style={styles.passwordContainer}>
                        ...
                        <TextInput
                            style={styles.passwordInput}
                            placeholder={t("setupPassword.confirmPasswordPlaceholder")}
                            placeholderTextColor="#aaaaaa"
